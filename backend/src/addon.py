...
for research_scan_path in get_research_layer_scan_paths(get_base_scan_path()):
    paths_registry.add_scan_path(research_scan_path)
...
for research_task_scan_path in get_research_layer_task_scan_paths(get_base_scan_path()):
    task_directories_registry.add_scan_path(research_task_scan_path)
