...
setup_environment(
    load_env_file_name=os.getenv("ENV_FILE", ".env"),
...
from infra_layer.adapters.input.jobs.memorize_job import memorize_single_message_job


class WorkerSettings:
    functions = [memorize_single_message_job]
    on_startup = startup
