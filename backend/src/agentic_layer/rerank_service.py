...
class HybridRerankConfig:
    ...
    # Provider types
    primary_provider: str = "vllm"  # vllm, deepinfra, or siliconflow
    fallback_provider: str = "deepinfra"  # vllm, deepinfra, siliconflow, or none
...
def _create_service_from_config(
    ...
    Args:
        provider: Provider type (vllm, deepinfra, or siliconflow)
